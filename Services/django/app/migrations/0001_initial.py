    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ethereum_address', models.CharField(blank=True, max_length=150, verbose_name='ethereum address')),
                ('infura_api_key', models.CharField(blank=True, max_length=150, verbose_name='infura api key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('creator', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='room_creator', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transaction_recipient', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transaction_sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddIndex(
            model_name='user',
        ...
        migrations.AddIndex(
            model_name='post',
            index=models.Index(fields=['user_id', 'timestamp'], name='app_post_user_id_78f9d3_idx'),
        ),
        migrations.AddIndex(
            model_name='room',
        ...
        migrations.AddIndex(
            model_name='roominvitation',
            index=models.Index(fields=['to_user_id'], name='app_roominv_to_user_24389e_idx'),
        ),
        migrations.AddIndex(
            model_name='roominvitation',
            index=models.Index(fields=['room_id', 'to_user_id'], name='app_roominv_room_id_dc5966_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['sender_id', 'recipient_id', 'timestamp'], name='app_transac_sender__ffe213_idx'),
        ),
    ]
